...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFCD535);
  late Color secondary = const Color(0xFFC88A06);
  late Color tertiary = const Color(0xFF6D604A);
  late Color alternate = const Color(0xFFC8D7E4);
  late Color primaryText = const Color(0xFFEAECEF);
  late Color secondaryText = const Color(0xFF848E9C);
